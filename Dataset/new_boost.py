...
X_train, X_test, y_train, y_test = train_test_split(X1, y, test_size = 0.02, random_state = 0)
...
#================2nd model==============================================
X2_train, X2_test, y2_train, y2_test = train_test_split(X, y2, test_size = 0.02, random_state = 0)
...
set_year_list = set()
for i in df_to_test['listing_year']:
    set_year_list.add(i)
